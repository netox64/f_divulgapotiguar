...
export class CardBasic extends Component<ICardBasic> {
    ...
    render(): ReactNode {
        const { checked, title, guidance, children, fnCheck, id } = this.props;
            ...
            return (
                <div className="max-w-full h-[200px] flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 transition-colors">
                    <div className="w-full h-[200px] overflow-hidden">
                        <Image className="w-full h-0 md:h-full object-cover rounded-t-lg md:rounded-none md:rounded-s-lg" src="/imgs/resort-town.jpg" alt={`Imagem demonstrativa do imóvel ${title}`} width={100} height={200} />
                    </div>
                    <div className="flex flex-col justify-center items-start leading-normal w-full pl-2">
                        ...
                        <div className="w-full flex items-center justify-between px-2">
                            <Link href={"/"} className="inline-flex items-center px-2 py-1 my-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Ver Mais
                ...
                <div className="max-w-72 bg-white border border-gray-200 rounded-lg shadow">
                    <Link href={"/"}>
                        <div className="relative w-full h-64 rounded-t-lg overflow-hidden">
                            <Image className="rounded-t-lg" src={"/imgs/resort-town.jpg"} alt={`imagem demonstrativa do imóvel ${title}`} fill style={{ objectFit: "cover" }} />
                        </div>
                    </Link>
                    <div className="p-5">
                        <Link href={"/"}>
